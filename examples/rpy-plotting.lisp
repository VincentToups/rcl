...
;;   [plot x y1 :col "blue" :type "o"]
;;   [points x y2 :col "red" :type "o"]
;;   [axis 1 :at x :label xlabels :lwd 1 :cex.axis 1.15]
;;   [title "My Plot"])
...
(let* ((x (loop for i from 0 below 10 collect i))
  ...
  (r "title" "My Plot")
  (r "dev.off"))
;; [postscript "somefile.ps" :paper "letter"]
;; [plot x y1 :col "blue" :type "o"]
;; [points x y2 :col "red" :type "o"]
;; [axis 1 :at x :label xlabels :lwd 1 :cex.axis 1.15]
;; [title "My Plot"]
...
;;       [plot x y1 :xlab "horizontal" :ylab "vertical" 
;;       :col "blue" :type "o" :axes 'F]
;;       ;; I can't use :axes nil, it's not properly converted to R
;;       [points x y2  :col  "red" :type "o"]
